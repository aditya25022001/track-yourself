  ...
  return (
    <div className="App">
      <div className="todo_header">
        <div className="todos_for_the_day" style={{ fontWeight:600, fontSize:'150%', marginBottom:'5%' }}>To Do's For {date.getDate()+"/"+(date.getMonth()+1)+"/"+date.getFullYear()} </div>
        <div className="todo_input" style={{ marginBottom:'3%' }}>
          ...
          <input className="input_time_todo" 
                ...
                value={inputTime} 
                onChange={ e => {
                  if( e.target.value.slice(0,2)==date.getHours() && e.target.value.slice(3,)>date.getMinutes() ||  e.target.value.slice(0,2)>date.getHours())
